...
const menu = {
    ...
    'Controls/Map view/Flip objects horizontally': { path: ['Edit', 'Transform', 'Flip Horizontally'], shortcut: { key: 'F', modifiers: ['Ctrl', ] } },
    'Controls/Map view/Flip objects vertically': { path: ['Edit', 'Transform', 'Flip Vertically'], shortcut: { key: 'F', modifiers: ['Ctrl', 'Alt', ] } },
    'Menu/Edit/Move objects': { path: ['Edit', 'Transform', 'Move...'], shortcut: { key: 'M', modifiers: ['Ctrl', 'Alt', ] } },
    ...
    'Menu/Edit/Snap Vertices to Integer': { path: ['Edit', 'Vertices', 'Snap Vertices to Integer'], shortcut: { key: 'V', modifiers: ['Ctrl', 'Shift', ] } },
    'Menu/Edit/Snap Vertices to Grid': { path: ['Edit', 'Vertices', 'Snap Vertices to Grid'], shortcut: { key: 'V', modifiers: ['Ctrl', 'Alt', 'Shift', ] } },
    ...
    'Menu/Edit/Replace Texture...': { path: ['Edit', 'Textures', 'Replace Texture...'], shortcut: { key: '', modifiers: [] } },
    'Menu/Edit/Select All': { path: ['Selection', 'Select All'], shortcut: { key: 'A', modifiers: ['Ctrl', ] } },
    'Menu/Edit/Invert Selection': { path: ['Selection', 'Invert Selection'], shortcut: { key: 'A', modifiers: ['Ctrl', 'Alt', ] } },
    'Menu/Edit/Deselect All': { path: ['Selection', 'Deselect All'], shortcut: { key: 'A', modifiers: ['Ctrl', 'Shift', ] } },
    ...
    'Menu/Edit/Select Tall': { path: ['Selection', 'Select Tall'], shortcut: { key: 'E', modifiers: ['Ctrl', 'Shift', ] } },
    'Menu/Edit/Select by Line Number': { path: ['Selection', 'Select by Line Number...'], shortcut: { key: '', modifiers: [] } },
    'Menu/Edit/Group': { path: ['Groups', 'Group Selected Objects'], shortcut: { key: 'G', modifiers: ['Ctrl', ] } },
    'Menu/Edit/Ungroup': { path: ['Groups', 'Ungroup Selected Objects'], shortcut: { key: 'G', modifiers: ['Ctrl', 'Shift', ] } },
    'Menu/Edit/Rename Groups': { path: ['Groups', 'Rename Selected Groups'], shortcut: { key: 'G', modifiers: ['Ctrl', 'Alt', ] } },
    'Menu/Edit/Create Linked Duplicate': { path: ['Groups', 'Create Linked Duplicate'], shortcut: { key: 'D', modifiers: ['Ctrl', 'Shift', ] } },
    'Menu/Edit/Select Linked Groups': { path: ['Groups', 'Select Linked Groups'], shortcut: { key: '', modifiers: [] } },
    'Menu/Edit/Separate Linked Groups': { path: ['Groups', 'Separate Selected Groups'], shortcut: { key: '', modifiers: [] } },
    'Menu/Edit/Clear Protected Properties': { path: ['Groups', 'Clear Protected Properties'], shortcut: { key: '', modifiers: [] } },
    ...
    'Controls/Map view/Deactivate current tool': { path: ['Tools', 'Deactivate Current Tool'], shortcut: { key: 'Esc', modifiers: ['Shift', ] } },
